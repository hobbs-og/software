...
object SoftwareTokens {
    object Accordion {
        ...
        val colorBorderDefault: ComposeColor
            @Composable @ReadOnlyComposable
            get() = if (isSoftwareDarkTheme()) ComposeColor(0xFF42454E) else ComposeColor(0xFF8C8F9B)
    ...
    object Button {
        ...
        val colorOutlineBackgroundFocus: ComposeColor
            @Composable @ReadOnlyComposable
            get() = if (isSoftwareDarkTheme()) ComposeColor(0xFF161925) else ComposeColor(0xFFC5C6C9)
    ...
    object Color {
        ...
        val borderSubtleHover = ComposeColor(0xFF6F7078)
